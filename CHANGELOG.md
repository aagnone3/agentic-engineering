...
All notable changes to the `@aagnone3/agentic-plugin` CLI tool will be documented in this file.
...
- **Native Cursor plugin support** — Cursor now installs via `/add-plugin agentic-engineering` using Cursor's native plugin system instead of CLI conversion ([#184](https://github.com/EveryInc/compound-engineering-plugin/pull/184)) — thanks [@ericzakariasson](https://github.com/ericzakariasson)!
