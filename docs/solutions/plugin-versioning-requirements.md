...
```markdown
Before committing changes to agentic-engineering plugin:
...
- `/Users/anthonyagnone/code/compound-engineering-plugin/plugins/agentic-engineering/.claude-plugin/plugin.json`
- `/Users/anthonyagnone/code/compound-engineering-plugin/plugins/agentic-engineering/CHANGELOG.md`
- `/Users/anthonyagnone/code/compound-engineering-plugin/plugins/agentic-engineering/README.md`
